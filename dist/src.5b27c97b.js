...
},{"./emptyFunction":32}],40:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./lib/ReactPropTypesSecret":40}],26:[function(require,module,exports) {
...
},{"object-assign":31,"fbjs/lib/invariant":29,"fbjs/lib/emptyObject":28,"fbjs/lib/warning":30,"fbjs/lib/emptyFunction":32,"prop-types/checkPropTypes":33}],25:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react.development.js":26}],34:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./isNode":43}],37:[function(require,module,exports) {
'use strict';
...
},{"./isTextNode":41}],42:[function(require,module,exports) {
'use strict';
...
},{"./camelize":44}],27:[function(require,module,exports) {
/** @license React v16.4.1
...
},{"fbjs/lib/invariant":29,"react":25,"fbjs/lib/warning":30,"fbjs/lib/ExecutionEnvironment":34,"object-assign":31,"fbjs/lib/emptyFunction":32,"prop-types/checkPropTypes":33,"fbjs/lib/getActiveElement":35,"fbjs/lib/shallowEqual":36,"fbjs/lib/containsNode":37,"fbjs/lib/emptyObject":28,"fbjs/lib/hyphenateStyleName":38,"fbjs/lib/camelizeStyleName":39}],24:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react-dom.development.js":27}],6:[function(require,module,exports) {
...
},{"../lit-html.js":18}],52:[function(require,module,exports) {
'use strict';
...
},{"../lit-html.js":18,"./modify-template.js":53}],51:[function(require,module,exports) {
'use strict';
...
var Card = function (_HTMLElement) {
  ...
  _createClass(Card, [{
    ...
    value: function render(title) {
      var template = (0, _shadyRender.html)(_templateObject, title);
      (0, _shadyRender.render)(template, this.shadow, 'sample-card');
    }
  }]);
...
},{"lit-html/lib/shady-render.js":52}],50:[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
var mock1 = exports.mock1 = [{
  title: 'title1'
}, {
  title: 'title2'
}, {
...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      var mock = isChanged ? _mock.mock2 : _mock.mock1;
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { style: wrapStyle },
          mock.map(function (item, id) {
            return _react2.default.createElement('app-card', { title: item.title, key: 'item-' + id });
          })
        ),
        _react2.default.createElement(
          'button',
          { type: 'button', onClick: this.handleChange },
          'change data'
        )
      );
    }
...
exports.default = App;
},{"react":25,"./mock":50}],4:[function(require,module,exports) {
'use strict';
...
},{"react":25,"react-dom":24,"@webcomponents/webcomponentsjs/webcomponents-bundle.js":6,"@webcomponents/webcomponentsjs/custom-elements-es5-adapter.js":8,"./web-components/Card":51,"./App":49}],45:[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/src.5b27c97b.map